...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="canonical" href="./Backbone.min_files/Backbone.min.js">
...
<body>
  ...
  <div id="sidebar" class="interface">
    ...
    <ul class="toc_section">
      ...
      <li>– <a href="http://backbonejs.org/#Model-change">change</a></li>
    ...
    <ul class="toc_section">
      ...
      <li>– <a href="http://backbonejs.org/#Collection-getByCid">getByCid</a></li>
    ...
    <ul class="toc_section">
      ...
      <li>– <a href="http://backbonejs.org/#View-dollar">$ (jQuery or Zepto)</a></li>
      <li>– <a href="http://backbonejs.org/#View-render">render</a></li>
      <li>– <a href="http://backbonejs.org/#View-remove">remove</a></li>
      <li>– <a href="http://backbonejs.org/#View-make">make</a></li>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#Utility-noConflict">noConflict</a></li>
      <li>– <a href="http://backbonejs.org/#Utility-setDomLibrary">setDomLibrary</a></li>
    </ul>
    ...
    <ul class="toc_section">
      ...
      <li>– <a href="http://backbonejs.org/#examples-linkedin">LinkedIn Mobile</a></li>
      ...
      <li>– <a href="http://backbonejs.org/#examples-do">Do</a></li>
      ...
      <li>– <a href="http://backbonejs.org/#examples-prose">Prose</a></li>
      <li>– <a href="http://backbonejs.org/#examples-scrollkit">scroll kit</a></li>
      <li>– <a href="http://backbonejs.org/#examples-battlefield">Battlefield Play4Free</a></li>
      ...
      <li>– <a href="http://backbonejs.org/#examples-decide">Decide</a></li>
      <li>– <a href="http://backbonejs.org/#examples-trello">Trello</a></li>
      <li>– <a href="http://backbonejs.org/#examples-quietwrite">QuietWrite</a></li>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#FAQ-events">Catalog of Events</a></li>
  ...
  <div class="container">
    ...
    <p>
      <img id="logo" src="./Backbone.min_files/backbone.png" alt="Backbone.js">
    </p>
    ...
    <p>
      ...
      as well as an online <a href="http://backbonejs.org/test/test.html">test suite</a>,
    ...
    <table>
      <tbody><tr>
        <td><a class="punch" href="./Backbone.min_files/backbone.js">Development Version (0.9.2)</a></td>
        <td class="text"><i>52kb, Full source, lots of comments</i></td>
      </tr>
      <tr>
        <td><a class="punch" href="http://backbonejs.org/backbone-min.js">Production Version (0.9.2)</a></td>
    ...
    <p>
      ...
      <a href="http://backbonejs.org/#changelog">change log</a> available, and many new features to
    ...
    <ul>
      <li>
        ...
        <a href="http://backbonejs.org/#View-setElement">setElement</a> instead.
      </li>
      <li>
        ...
        success. You can now also pass <tt>{wait: true}</tt> to <a href="http://backbonejs.org/#Model-save">save</a> calls.
      </li>
      <li>
        If you have been writing a fair amount of <tt>$(view.el)</tt>, there's now
        a cached reference for that jQuery object: <a href="http://backbonejs.org/#View-$el">$el</a>.
      </li>
      <li>
...
book.set("title", "A Scandal in Bohemia");
    ...
    <p>
      If the model has a <a href="http://backbonejs.org/#Model-validate">validate</a> method,
...
alert("Cake id: " + cake.id);
    ...
    <p id="Model-attributes">
      ...
      state. Please use <a href="http://backbonejs.org/#Model-set">set</a> to update the attributes instead of modifying
      them directly. If you'd like to retrieve and munge a copy of the model's
      attributes, use <a href="http://backbonejs.org/#Model-toJSON">toJSON</a> instead.
    </p>
    ...
    <p id="Model-changed">
      ...
      by <a href="http://backbonejs.org/#Model-set">set</a> and <a href="http://backbonejs.org/#Model-change">change</a>.
...
alert("Dessert will be " + (new Meal).get('dessert'));
    ...
    <p id="Model-toJSON">
      ...
      <br>
      Return a copy of the model's <a href="http://backbonejs.org/#Model-attributes">attributes</a> for JSON stringification.
...
<pre>ActiveRecord::Base.include_root_in_json = false
    ...
    <p id="Model-change">
      ...
      <tt>{silent: true}</tt> to the <a href="http://backbonejs.org/#Model-set">set</a> function in order to
...
<pre>var Library = Backbone.Collection.extend({
  model: Book
    ...
    <p id="Collection-constructor">
      ...
      The collection's <a href="http://backbonejs.org/#Collection-comparator">comparator</a> function
...
var alphabetical = Books.sortBy(function(book) {
  return book.author.get("name").toLowerCase();
    ...
    <p id="Collection-add">
      ...
      <a href="http://backbonejs.org/#Collection-model">model</a> property is defined, you may also pass
...
alert(chapters.pluck('title'));
    ...
    <p id="Collection-sort">
      ...
      normal circumstances, as a collection with a <a href="http://backbonejs.org/#Collection-comparator">comparator</a> function
...
app.navigate("help/troubleshooting", {trigger: true, replace: true});
    ...
    <p>
      ...
      of <a href="http://backbonejs.org/#Router">Routers</a> with <a href="http://backbonejs.org/#Router-routes">routes</a>.
    </p>
...
<div class="run" title="Run"></div><pre class="runnable">var view = new Backbone.View;
...
var model = localBackbone.Model.extend(...);
    ...
    <p id="examples-todos">
      ...
      <a href="http://backbonejs.org/docs/backbone-localstorage.html">LocalStorage adapter</a>
    ...
    <div style="text-align: center;">
      <a href="http://wordpress.com/">
        <img width="550" height="387" data-original="docs/images/wpcom-notifications.png" alt="WordPress.com Notifications" title="WordPress.com Notifications" class="example_image">
      </a>
    </div>
    ...
    <ul class="small">
      ...
      <li><b>"destroy"</b> (model, collection) — when a model is <a href="http://backbonejs.org/#Model-destroy">destroyed</a>. </li>
      <li><b>"sync"</b> (model, collection) — triggers whenever a model has been successfully synced to the server. </li>
      <li><b>"error"</b> (model, collection) — when a model's validation fails, or a <a href="http://backbonejs.org/#Model-save">save</a> call fails on the server. </li>
...
&lt;/script&gt;
    ...
    <p id="FAQ-this">
      ...
      Backbone, when dealing with <a href="http://backbonejs.org/#Events">events</a> and callbacks,
...
<pre>ActiveRecord::Base.include_root_in_json = false
    ...
    <p>
      ...
      <a href="http://documentcloud.org/" title="A DocumentCloud Project" style="background:none;">
        <img src="./Backbone.min_files/a_documentcloud_project.png" alt="A DocumentCloud Project" style="position:relative;left:-10px;">
      </a>
    </p>

  </div>

  <script src="./Backbone.min_files/underscore-1.3.1.js"></script>
  <script src="./Backbone.min_files/jquery-1.7.1.js"></script>
  <script src="./Backbone.min_files/jquery.lazyload.js"></script>
  <script src="./Backbone.min_files/json2.js"></script>
  <script src="./Backbone.min_files/backbone.js"></script>
